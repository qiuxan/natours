...
class APIFeature {
    constructor(query, queryString) {
        ...
        console.log("🚀 ~ file: tourController.js:8 ~ APIFeature ~ constructor ~ queryString:", queryString)
    }
...
exports.getAllTours = async (req, res) => {
    ...
    try {
        ...
        // req.query
        console.log("🚀 ~ file: tourController.js:126 ~ exports.getAllTours= ~ req.query:", req.query)
...
exports.aliasTopTours = (req, res, next) => {
    ...
    console.log("🚀 ~ file: tourController.js:259 ~ req.query:", req.query)
